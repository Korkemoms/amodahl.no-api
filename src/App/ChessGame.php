...
class ChessGame extends \Spot\Entity
{
    ...
    public static function fields()
    {
        return [
            ...
            "white_player_name" => ["type" => "string", "length" => 255],
            "black_player_name" => ["type" => "string", "length" => 255],
            "white_player_uid" => ["type" => "string", "length" => 16],
            "black_player_uid" => ["type" => "string", "length" => 16],
